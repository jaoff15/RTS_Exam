...
HD_PWD='/home/jacoboffersen/eclipse-workspace/RTS_Exam/RTS_Exam.runs/design_1_des_encryption_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_des_encryption_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_des_encryption_0_0.tcl
